...
console.log("Aplicando la función find para encontrar el primer taller de la Ing. María López");
...
console.log("Aplicando la función reduce para calcular el total de inscritos");
...
const conCupoDisponible = talleres
